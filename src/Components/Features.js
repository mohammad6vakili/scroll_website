...
const Features = () => {
  ...
  const fBlock3 = (
    <div className={classes.featureBlock}>
      ...
      <div className={classes.description}>
        <p className={classes.bigText}>NFT card ownership</p>
        <p className={classes.smallText}>
          Explore enhanced benefits as a Flibbo member through NFT card
          ownership: receive monthly royalty income, earn based on impressions
          and creator revenue, gain access to a virtual Mastercard, enjoy free
          ad account credits, and enable profile subscription earnings from your
          followers
        </p>
        {/*  <div className={classes.icons}>
          <div className={classes.iconItem}>
